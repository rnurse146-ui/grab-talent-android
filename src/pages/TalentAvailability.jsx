...
export default function TalentAvailability() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      {/* Nav */}
      <div className="flex items-center justify-between px-6 pb-4 pt-[calc(env(safe-area-inset-top)+1rem)] border-b border-slate-800 sticky top-0 md:top-14 z-10 bg-slate-950/90 backdrop-blur-sm">
